...
public class Validator {
	 ...
	 * @return <code>true</code> if the characters are equal;
	 ...
	 *         instance, or both <code>null</code>; <code>false</code>
	 *         otherwise
	 */
	 ...
	 * requirements are that the string consist of two parts separated by an @ symbol,
	 * and that it contain no whitespace.
	 * 
	 * @param address
	 *            the string to check
	...
	/**
	 * Returns <code>true</code> if the string is an alphanumeric name,
	 * meaning it contains nothing but English letters, numbers, and spaces.
	 * 
	 * @param name
	 *            the string to check
	...
	/**
	 * Returns <code>true</code> if the character is in the ASCII character
	 * set. This includes characters with integer values between 32 and 126
	 * (inclusive).
	 * 
	 * @param c
	 *            the character to check
	 * @return <code>true</code> if the character is in the ASCII character
	...
	/**
	 * Returns <code>true</code> if string consists only of upper and lower
	 * case English letters.
	 * 
	 * @param s
	 *            the string to check
	 * @return <code>true</code> if the string consists only of upper and
	...
	/**
	 * Returns <code>true</code> if the date is valid in the Gregorian
	 * calendar.
	 * 
	 * @param month
	 *            the month to check
	...
	/**
	 * Returns <code>true</code> if the string consists of only digits between
	 * 0 and 9 (inclusive).
	 * 
	 * @param s
	 *            the string to check
	 * @return <code>true</code> if the string consists of only digits between
	 *         0 and 9 (inclusive); <code>false</code> otherwise
	 */
	...
	/**
	 * Returns <code>true</code> if the string contains a valid number
	 * according to the Luhn algorithm, commonly used to validate credit card
	 * numbers.
	 * 
	 * @param number
	 *            the string to check
	 * @return <code>true</code> if the string contains a valid number
	 *         according to the Luhn algorithm; <code>false</code> otherwise
	 */
	 ...
	 * <code>null</code>, meaning it is neither a <code>null</code>
	 * reference or zero.
	 * 
	 * @param l
	...
	/**
	 * Returns <code>true</code> if the object is not <code>null</code>,
	 * using the rules from {@link #isNotNull(Long)} or
	 ...
	 * meaning it is neither a <code>null</code> reference or empty.
	 * 
	 * @param array
	 *            the array to check
	...
	/**
	 * Returns <code>true</code> if the string is not <code>null</code>,
	 * meaning it is not a <code>null</code> reference, nothing but spaces, or
	...
	/**
	 * Returns <code>true</code> if the long number object is
	 * <code>null</code>, meaning it is either a <code>null</code>
	 * reference or zero.
	 * 
	 * @param l
	 *            the long number object to check
	 * @return <code>true</code> if the long number object is
	 *         <code>null</code>; <code>false</code> otherwise
	 */
	...
	/**
	 * Returns <code>true</code> if the object is <code>null</code>, using
	 * the rules from {@link #isNull(Long)} or {@link #isNull(String)} if the
	...
	/**
	 * Returns <code>true</code> if the array is <code>null</code>, meaning
	 * it is either a <code>null</code> reference or empty.
	 * 
	 * @param array
	 *            the array to check
	...
	/**
	 * Returns <code>true</code> if the string is <code>null</code>,
	 * meaning it is a <code>null</code> reference, nothing but spaces, or the
	...
	/**
	 * Returns <code>true</code> if the string is a valid phone number. The
	 * only requirement is that there are decimal digits in the string; length
	 * and format are not checked.
	 * 
	 * @param phoneNumber
	 *            the string to check
	...
	/**
	 * Returns <code>true</code> if the string is a valid URL based on the
	 * rules in {@link java.net.URL}.
	 * 
	 * @param url
	 *            the string to check
	...
	/**
	 * Returns <code>true</code> if the string is a valid variable name in
	 * Java.
	 * 
	 * @param variableName
	 *            the string to check
	 * @return <code>true</code> if the string is a valid variable name in
	 *         Java; <code>false</code> otherwise
	 */
	...
	/**
	 * Returns <code>true</code> if the string is a valid variable term,
	 * meaning it begins with "[$" and ends with "$]".
	 * 
	 * @param s
	 *            the string to check
