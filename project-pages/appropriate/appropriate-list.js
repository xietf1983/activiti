...
function downloadExcel() {
	try {
		Ext.get('ExcelDownIFrame').dom.src ="Template.xlsx";
	}catch(e){};
}
function init() {
	Ext.QuickTips.init();
	...
	var field = new Ext.form.DropOrgCheckALLField({
		selectOnFocus : true,
		allowBlank : false,
	...
	//tb.add('-');
	tb.add('<a class="l-btn"  href=javascript:downloadExcel() ><span class="l-btn-left"><span class="l-btn-text icon-utils-s-excel l-btn-icon-left" >模板下载</span> </span></a>');
	tb.add('-');
