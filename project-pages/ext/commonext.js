...
// ÔøΩÔøΩÔøΩÔøΩwindwÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩŒª
...
// ÔøΩÔøΩÔøΩ…ªÔøΩÔøΩÔøΩEXTÔøΩÔøΩalert
...
// ÔøΩÔøΩÔøΩ…ªÔøΩÔøΩÔøΩEXTÔøΩÔøΩwarring
...
// ÔøΩÔøΩÔøΩ…ªÔøΩÔøΩÔøΩEXTÔøΩÔøΩConfirm
...
/*
 * ÔøΩÔøΩ»°ÔøΩÔøΩ«∞“≥ÔøΩÔøΩÔøΩÔøΩ÷∏ÔøΩÔøΩÔøΩÔøΩÔøΩ∆µÔøΩURLÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩ queryStringNameÔøΩÔøΩurlÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩ
 */
...
/*
 * ÔøΩÔøΩjsoÔøΩ–µÔøΩ÷µÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩclsNameÔøΩÔøΩspanÔøΩÔøΩ
 */
...
/*
 * ÔøΩÔøΩÔøΩÔøΩclassnameÔøΩÔøΩ»°element list
 */
...
Ext.form.DropTree = Ext.extend(Ext.form.TriggerField, {
	...
	onRender : function(ct, position) {
		...
		// ÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩ µÔøΩÔøΩ÷µ
	...
	initLiveTree : function(url) {
		...
		if (this.dropLayer == null) {
			...
			this.dropLayer.loader.on('beforeload', function(treeLoader, node) { // ÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩ
				this.baseParams.parentId = node.attributes.id;
				this.baseParams.appselect = me.appselect;

			});
			this.dropLayer.loader.on('load', function(treeLoader, node) { // ÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩ
				if (node == root) {
...
function gridSpan (grid, rowOrCol, cols, sepCol) {
	...
	for (i = 0; i < rows.length; i++) {
		...
		// cls.removeClass("x-grid3-row");//»•µÙ‘≠¿¥µƒ—˘ Ω
		// cls.addClass("my-x-grid3-row");//º”…œ◊‘º∫µƒ—˘ Ω
	}
};
